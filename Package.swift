...
if useLocalFFI {
    ...
    targets.append(
        .binaryTarget(
            name: "libzcashlc",
            url: "https://github.com/zcash/zcash-swift-wallet-sdk/releases/download/2.5.2/libzcashlc.xcframework.zip",
            checksum: "27089796e15eacd0e5a90e7ea01884ea5c40806cf25a6fa9a6aca933dad65813"
        )
    )
